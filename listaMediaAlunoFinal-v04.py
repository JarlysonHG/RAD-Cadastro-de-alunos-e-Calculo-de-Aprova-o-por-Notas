...
janela = tk.Tk()
principal=PrincipalCadastroAlunos(janela)
janela.title('Bem Vindo ao Cadastro de Alunos')
janela.geometry("820x600+10+10")
janela.mainloop()
janela.iconbitmap('\icone.ico')
janela.iconphoto(False, PhotoImage(file='icone.ico'))